...
def test_cuisine_1():
    ...
    result = requests.get(
        f"http://192.168.30.17:5000/filter/cuisine?type={cuisine_type}"
    )
...
def test_neighborhood_1():
    ...
    result = requests.get(
        f"http://192.168.30.17:5000/filter/neighborhood?neighborhood={neighborhood}"
    )
...
def test_score():
    score = 4.7
    result = requests.get(
        f"http://192.168.30.17:5000/filter/score?score={score}"
    )
